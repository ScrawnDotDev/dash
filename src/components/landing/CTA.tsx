...
export function CTA() {
  ...
  return (
    <section ref={containerRef} className="relative overflow-hidden border-b-4 border-black bg-yellow-400 py-32 lg:py-48 dark:border-white">
      ...
      >
        {[...Array(6)].map((_, i) => (
          <div key={i} className="whitespace-nowrap font-mono text-[10rem] font-black uppercase leading-[0.8] tracking-tighter text-black md:text-[15rem] lg:text-[20rem]">
      ...
      <div className="relative z-10 mx-auto max-w-[1400px] px-6 lg:px-12">
        ...
        >
          {/* Decorative Screws */}
          <div className="absolute left-4 top-4 h-4 w-4 border-4 border-black bg-yellow-400 dark:border-white" />
          <div className="absolute right-4 top-4 h-4 w-4 border-4 border-black bg-yellow-400 dark:border-white" />
          <div className="absolute bottom-4 left-4 h-4 w-4 border-4 border-black bg-yellow-400 dark:border-white" />
          <div className="absolute bottom-4 right-4 h-4 w-4 border-4 border-black bg-yellow-400 dark:border-white" />
          ...
          <motion.div
            ...
            dragElastic={0.15}
            className="absolute -right-8 -top-8 z-30 hidden cursor-grab active:cursor-grabbing lg:block"
            animate={{ rotate: [12, 16, 12], y: [-4, 4, -4] }}
            transition={{ duration: 4, repeat: Infinity, ease: "easeInOut" }}
          >
            <div className="border-4 border-black bg-red-500 px-6 py-4 font-mono text-xl font-black uppercase tracking-widest text-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] dark:border-white dark:shadow-[8px_8px_0px_0px_rgba(255,255,255,1)]">
              // END THE PAIN
            </div>
          </motion.div>

          <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-12 pt-6">
            <div className="max-w-3xl">
              ...
              <p className="mt-8 font-mono text-lg font-bold uppercase tracking-widest text-gray-500 md:text-xl">
