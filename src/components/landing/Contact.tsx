  ...
  return (
    <section className="border-b-4 border-black bg-[#f4f4f4] py-24 dark:border-white dark:bg-[#111]">
      <div className="mx-auto max-w-[1400px] px-6 lg:px-12 text-center">
        ...
        >
          <div className="mb-6 inline-block border-4 border-black bg-black px-4 py-2 font-mono text-sm font-black uppercase tracking-widest text-white shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] dark:border-white dark:bg-white dark:text-black dark:shadow-[6px_6px_0px_0px_rgba(255,255,255,1)]">
            STUCK?
          </div>
          <h2 className="mb-8 text-5xl font-black uppercase leading-[0.85] tracking-tighter text-black md:text-7xl lg:text-[6rem] dark:text-white">
          ...
          >
            <div className="absolute -top-4 -right-4 z-10 rotate-12 border-4 border-black bg-[#00ff00] px-4 py-2 font-mono text-xs font-black uppercase tracking-widest text-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] dark:border-white">
              EMAIL US
            </div>
